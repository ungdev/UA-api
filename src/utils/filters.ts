...
export const filterCartItem = (cartItem: CartItem) =>
  pick(cartItem, ['id', 'quantity', 'price', 'reducedPrice', 'cartId', 'itemId', 'forcePaid', 'forUser.id', 'forUser.username']);
...
export const filterCartItemAdmin = (cartItem: CartItem) =>
  pick(cartItem, ['id', 'quantity', 'price', 'reducedPrice', 'cartId', 'item.id', 'item.name', 'forcePaid', 'forUser.id', 'forUser.username']);
