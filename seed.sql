...
('animation_pokemon', 'Animation Pokémon', 'Anim Pokémon', 6, '#123456', 'animation'),
('animation_rl', 'Animation Rocket League', 'Anim RL', 7, '#123456', 'animation'),
('animation_ssbu', 'Animation SSBU', 'Anim SSBU', 8, '#123456', 'animation'),
('animation_tft', 'Animation TFT', 'Anim TFT', 9, '#123456', 'animation'),
('communication', 'Communication', 'Com',10, '#123456', NULL),
('coord', 'Coordinateur', 'Coord',0, '#123456', NULL),
('decoration', 'Décoration', 'Déco',11, '#123456', NULL),
('design', 'Graphisme', 'Graphisme',12, '#123456', NULL),
('dev', 'Développement', 'Dev',13, '#123456', NULL),
('electricity', 'Électricité', 'Élec',14, '#123456', NULL),
('logistique', 'Logistique', 'Log',15, '#123456', NULL),
...
('security', 'Sécurité', 'Sécu',20, '#123456', NULL),
('ssl', 'Scène, son et lumière', 'SSL', 21, '#123456', NULL);