...
('animation', 'Animation', 'Animation', 1, '#123456', NULL),
('animation_console', 'Animation stand console', 'Animation stand console', 2, '#123456', 'animation'),
('animation_cs2', 'Animation CS2', 'Animation CS2', 3, '#123456', 'animation'),
('animation_lol', 'Animation LoL', 'Animation LoL', 4, '#123456', 'animation'),
('animation_open', 'Animation tournoi libre', 'Animation tournoi libre', 5, '#123456', 'animation'),
('animation_pokemon', 'animation Pokémon', 'animation Pokémon', 6, '#123456', 'animation'),
('animation_rl', 'Animation Rocket League', 'Animation Rocket League', 7, '#123456', 'animation'),
('animation_ssbu', 'Animation SSBU', 'Animation SSBU', 8, '#123456', 'animation'),
('animation_tft', 'Animation TFT', 'Animation TFT', 9, '#123456', 'animation'),
('communication', 'Communication', 'Communication',10, '#123456', NULL),
('coord', 'Coordinateur', 'Coordinateur',0, '#123456', NULL),
('decoration', 'Décoration', 'Décoration',11, '#123456', NULL),
('design', 'Graphisme', 'Graphisme',12, '#123456', NULL),
('dev', 'Développement', 'Développement',13, '#123456', NULL),
('electricity', 'Électricité', 'Électricité',14, '#123456', NULL),
('logistique', 'Logistique', 'Logistique',15, '#123456', NULL),
('mediatik', 'Médiatik', 'Médiatik',16, '#123456', NULL),
('partners', 'Partenaires', 'Partenaires',17, '#123456', NULL),
('restauration', 'Restauration', 'Restauration',18, '#123456', NULL),
('rozo', 'Réseau', 'Réseau',19, '#123456', NULL),
('security', 'Sécurité', 'Sécurité',20, '#123456', NULL),
('ssl', 'Scène, son et lumière', 'Scène, son et lumière', 21, '#123456', NULL);