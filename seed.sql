...
('animation', 'Animation', 'Anim', 1, '#FACC15', NULL),
('animation_console', 'Animation stand console', 'Anim stand console', 2, '#FACC15', 'animation'),
('animation_cs2', 'Animation CS2', 'Anim CS2', 3, '#FACC15', 'animation'),
('animation_lol', 'Animation LoL', 'Anim LoL', 4, '#FACC15', 'animation'),
('animation_open', 'Animation tournoi libre', 'Anim tournoi libre', 5, '#FACC15', 'animation'),
('animation_osu', 'Animation osu!', 'Anim osu!', 6, '#FACC15', 'animation'),
('animation_pokemon', 'Animation Pokémon', 'Anim Pokémon', 7, '#FACC15', 'animation'),
('animation_rl', 'Animation Rocket League', 'Anim RL', 8, '#FACC15', 'animation'),
('animation_ssbu', 'Animation SSBU', 'Anim SSBU', 9, '#FACC15', 'animation'),
('animation_tft', 'Animation TFT', 'Anim TFT', 10, '#FACC15', 'animation'),
...
('security', 'Sécurité', 'Sécu', 21, '#A855F7', NULL),
