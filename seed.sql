...
('animation_tft', 'Animation TFT', 9, '#123456', 'animation'),
('communication', 'Communication', 10, '#123456', NULL),
('coord', 'Coordinateur', 0, '#123456', NULL),
('decoration', 'Décoration', 11, '#123456', NULL),
('design', 'Graphisme', 12, '#123456', NULL),
('dev', 'Développement', 13, '#123456', NULL),
('electricity', 'Électricité', 14, '#123456', NULL),
('logistique', 'Logistique', 15, '#123456', NULL),
('mediatik', 'Médiatik', 16, '#123456', NULL),
('partners', 'Partenaires', 17, '#123456', NULL),
('restauration', 'Restauration', 18, '#123456', NULL),
('rozo', 'Réseau', 19, '#123456', NULL),
('security', 'Sécurité', 20, '#123456', NULL),
('ssl', 'Scène, son et lumière', 21, '#123456', NULL);